    ...
    >
      ...
      <div>
        ...
        <input
          type="submit"
          value="Subscribe"
          className="shadow-submit dark:shadow-submit-dark mb-5 flex w-full cursor-pointer items-center justify-center rounded-sm bg-red-600 px-9 py-4 text-base font-medium text-white duration-300 hover:bg-red-600/90"
        />
